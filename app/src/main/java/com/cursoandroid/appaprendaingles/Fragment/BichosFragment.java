package com.cursoandroid.appaprendaingles.Fragment;
...
public class BichosFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonCao.setOnClickListener(this); // é a propria classe bichosFragment que vai tratar cada componente de interface
